...
SELECT _ FROM CUSTOMER; SELECT /_+ all*rows */ \_ FROM CUSTOMER;

조건절 비교 값

SELECT _ FROM CUSTOMER WHERE LOGIN_ID = 'tommy'; SELECT _ FROM CUSTOMER WHERE LOGIN*ID = 'karajan'; SELECT * FROM CUSTOMER WHERE LOGIN*ID = 'javaking'; SELECT * FROM CUSTOMER WHERE LOGIN_ID = 'oraking';
